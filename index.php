...
<body>
    ...
    <div id="turnstileWidget" class="cf-turnstile" data-sitekey="0x4AAAAAABCwDCOsWgAMdQxB" data-callback="onCaptchaSuccess"
            ...
            fetch('public/backend/verificar_turnstile.php', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        setTimeout(() => { window.location.href = 'public/views/landing_page.php'; }, 1000);
                    } else {
